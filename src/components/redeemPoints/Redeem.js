...
import FormalHeading from '../FormalHeading';
  ...
  const RedeemPoint = () => {
    function RewardBox(){
      return(
        <Box w='auto' h='100%' bg='white' boxShadow='0 4px 12px 0 black' borderRadius={20} p={4}>
          <Flex flexDirection='column' alignItems='center' w='100%'>
            <Image src='./amazon-gift-card.jpeg' w='90%' pt={3} pb={4}/>
              ...
              <Text color='black' align='center' style={{whiteSpace: 'pre-wrap', overflowWrap: 'break-word'}}>
                ...
                <Box align='center' color='black' pb={2} pt={10}>
    ...
    return (
      <VStack align='left' h='100%'>
        ...
        <Box w='175vh' overflowX='auto' whiteSpace='nowrap' css={{"&::-webkit-scrollbar": {height:"10px", width:'10px',},"&::-webkit-scrollbar-track": {background:'#D9D9D9', borderRadius:"50px",},"&::-webkit-scrollbar-thumb": {background:'#122543', borderRadius:"50px",},}}>
          <HStack pb={4} spacing='50px'>
            <RewardBox/>
            <RewardBox/>
            <RewardBox/>
            <RewardBox/>
