...
const Pricing = () => {
    return ( 
        <HStack spacing={20} textAlign='center'>
            <Box w='100%' h='500px' bg='white' boxShadow="0 4px 12px 0 black" borderRadius={20} padding='10px' margin='10px'>
            ...
            <Box w='100%' h='500px' bg='#0F2543' boxShadow="0 4px 12px 0 black" borderRadius={20} padding='10px' margin='10px'>
                <Stack w='100%' h='100%' alignItems='center'>
                    <Spacer></Spacer>
                    <Box boxSize='4em'>
