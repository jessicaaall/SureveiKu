    ...
    return (
        <VStack align="left" w="full" h="full">
            <FormalHeading title="PROFILE"/>
                <VStack align="left" w="full" h="full" css={{"&::-webkit-scrollbar": {width:"8px",},"&::-webkit-scrollbar-track": {background:"#D9D9D9", borderRadius:"50px",},"&::-webkit-scrollbar-thumb": {background:"#122543", borderRadius:"50px",},}} overflowX="auto" height="full">
                    <SimpleGrid rows={8} spacingY={5} mt="0.5%" mr="1.25%" w="auto" h="full">
                    ...
                    <Flex pl="85%" pr="1.25%" pt="1.75%" pb="0.5%">
                        <Button 
                            ...
                            w="100%"
                            fontSize={18}
                            _hover={{ bg:"#d66a1e"}}>EDIT PROFILE</Button>
                    </Flex>
                </VStack>
        </VStack>
    )
