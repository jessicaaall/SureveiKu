import {Box, Text, Image, Spacer, Stack, HStack, Button, VStack, Flex, UnorderedList, ListItem} from "@chakra-ui/react";
    ...
    return (
        <div>
            ...
            <Text color='white' fontSize={'3em'} fontWeight='bold'>AVAILABLE SURVEYS</Text>
                <Spacer></Spacer>
                <Box bg='white' w='auto' h='full' borderRadius={10}>
                <HStack p={5} spacing={20}>
                    <Box w='300px' h='700px' bg='white' boxShadow="0 4px 12px 0 black" borderRadius={20} padding={5}>
                        <Stack w='100%' h='100%'>
                            <Spacer></Spacer>
                    ...
                    <Box w='300px' h='700px' bg='white' boxShadow="0 4px 12px 0 black" borderRadius={20} padding={4} margin='2%'>
                        <Stack w='100%' h='100%'>
                            <Spacer></Spacer>
                            <Box boxSize={'15em'} w='100%'>
                                <Spacer></Spacer>
